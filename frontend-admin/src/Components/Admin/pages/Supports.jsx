...
const Support = () => {
  ...
  const fetchSupportData = async () => {
    ...
    try {
      ...
      const [ticketsRes, chatRes] = await Promise.allSettled([
        ...
        // axios.get("http://localhost:5000/api/support/chat"),
  ...
  const generateMockTickets = () => {
    ...
    return Array.from({ length: 15 }, (_, i) => ({
      ...
      assignedTo: ["John Doe", "Jane Smith", "Mike Johnson", null][Math.floor(Math.random() * 4)],
  ...
  const generateMockChatMessages = () => {
    return [
      ...
      },
      {
        id: 3,
        sender: "support",
        message: "I'd be happy to help you with that. Can you describe the specific issue you're experiencing?",
      ...
      },
      {
        id: 4,
        sender: "user",
        message: "When I try to add new menu items, the form doesn't submit properly.",
  ...
  const calculateSupportStats = (ticketsData) => {
    ...
    const open = ticketsData.filter((t) => t.status === "open" || t.status === "in-progress").length
  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      const supportResponse = {
        id: Date.now() + 1,
        sender: "support",
        message: "Thank you for your message. I'm looking into this issue for you.",
        timestamp: new Date(),
        senderName: "Support Agent",
      }
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">Last updated: {lastUpdated.toLocaleTimeString()}</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg font-bold text-gray-900 dark:text-white">{supportStats.avgResponseTime}</p>
            </div>
                ...
                <div className="bg-gradient-to-r from-green-500 to-green-600 p-6 rounded-lg text-white">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-green-100 text-sm">Response within 2 hours</p>
                    </div>
                  </div>
                ...
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-6 rounded-lg text-white">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-purple-100 text-sm">Instant messaging</p>
                    </div>
                  </div>
                  <p className="mb-4">Chat with our support agents in real-time</p>
                  <button
                  ...
                  {[
                    {
                      ...
                      answer: "Go to Settings → Account → Change Password, or contact support for assistance.",
                    },
                    {
                      question: "How do I add new menu items?",
                      answer: "Navigate to Menu → Add Item button, fill in the details and save.",
                    },
                    {
                    ...
                    },
                    {
                      ...
                      answer: "Reports can be generated from the Dashboard by clicking on the chart export options.",
                    },
                  ].map((faq, index) => (
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          <h4 className="font-semibold text-gray-900 dark:text-white">{ticket.id}</h4>
                          <span
                        ...
                        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">{ticket.subject}</h3>
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-sm text-gray-500 dark:text-gray-400">{ticket.responses} responses</span>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">+1-800-SUPPORT</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">support@restaurant.com</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">{selectedTicket.id}</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Ticket Details</h4>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">Status:</span>
                        <span
                          className={`px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(selectedTicket.status)}`}
                        >
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-gray-900 dark:text-white">{selectedTicket.category}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">Created:</span>
                        <span className="text-gray-900 dark:text-white">{formatTime(selectedTicket.createdAt)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">Updated:</span>
                        <span className="text-gray-900 dark:text-white">{formatTime(selectedTicket.updatedAt)}</span>
                      </div>
                      {selectedTicket.assignedTo && (
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">Assigned to:</span>
                          <span className="text-gray-900 dark:text-white">{selectedTicket.assignedTo}</span>
                        </div>
                      )}
                    </div>
                  </div>
