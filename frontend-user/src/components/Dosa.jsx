...
import dosaImage from "../assets/dosa-menu.jpg" // Replace with actual image path
...
export default function DosaMenu() {
  ...
  const [addOns, setAddOns] = useState([
    ...
    { name: "CHEESE FILLING", price: 25, quantity: 0 },
    { name: "SPICY MASALA", price: 12, quantity: 0 },
  ])
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/dosa") // Updated API endpoint
      ...
      <div className="relative h-[40vh] md:h-screen md:w-1/2 lg:w-3/5">
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-black/20 flex items-end p-8">
          <div>
            ...
            <p className="text-xl text-gray-200">Crispy crepes with authentic South Indian flavors</p>
          </div>
        </div>
      ...
      <div className="flex flex-1 flex-col bg-gray-50 md:h-screen md:overflow-hidden">
        <div className="sticky top-0 bg-gray-50 p-6 pb-4 z-10 shadow-sm">
          ...
          <h2 className="text-3xl font-bold">
            <span className="text-[#ff3131]">Flavors of South India</span> <span className="text-[#122348]">Dosa</span>
          </h2>
          <p className="text-gray-600 mt-1">Select your favorite dosa from our authentic collection</p>
        </div>
