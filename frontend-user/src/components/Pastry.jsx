...
import pastriesImage from "../assets/pastriesmenu.jpg" // Replace with actual image path
...
export default function PastriesMenu() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/pastries") // Updated API endpoint
      ...
      <div className="relative h-[40vh] md:h-screen md:w-1/2 lg:w-3/5">
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-black/20 flex items-end p-8">
          <div>
            ...
            <p className="text-xl text-gray-200">Flaky, buttery, and utterly delightful</p>
          </div>
        </div>
        <img src={pastriesImage} alt="Pastries Dish" className="object-cover w-full h-full" />
      </div>
      {/* Menu Section */}
      <div className="flex flex-1 flex-col bg-gray-50 md:h-screen md:overflow-hidden">
        <div className="sticky top-0 bg-gray-50 p-6 pb-4 z-10 shadow-sm">
          ...
          <h2 className="text-3xl font-bold">
            <span className="text-[#ff3131]">Flavors of Sweetness</span> <span className="text-[#122348]">Pastries</span>
          </h2>
          <p className="text-gray-600 mt-1">Select your favorite pastry from our delightful collection</p>
        </div>
