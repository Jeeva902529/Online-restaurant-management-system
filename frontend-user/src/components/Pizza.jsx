...
import pizzaImage from "../assets/pizzamenu.jpg" // Replace with actual image path
...
export default function PizzaMenu() {
  ...
  const [addOns, setAddOns] = useState([
    ...
    { name: "JALAPEÑOS", price: 15, quantity: 0 },
    { name: "MUSHROOMS", price: 25, quantity: 0 },
    { name: "OLIVES", price: 10, quantity: 0 },
    { name: "SAUSAGE", price: 30, quantity: 0 },
  ])
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/pizza") // Updated API endpoint
      .then((response) => setPizzaVarieties(response.data))
    ...
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      <div className="relative h-[40vh] md:h-screen md:w-1/2 lg:w-3/5">
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-black/20 flex items-end p-8">
          <div>
            <h1 className="text-5xl font-bold text-white mb-2">PIZZA</h1>
            <p className="text-xl text-gray-200">Cheesy delights with bold toppings</p>
          </div>
        </div>
      ...
      <div className="flex flex-1 flex-col bg-gray-50 md:h-screen md:overflow-hidden">
        <div className="sticky top-0 bg-gray-50 p-6 pb-4 z-10 shadow-sm">
          ...
          <h2 className="text-3xl font-bold">
            <span className="text-[#ff3131]">Flavors of Italy</span> <span className="text-[#122348]">Pizza</span>
          </h2>
          <p className="text-gray-600 mt-1">Select your favorite pizza from our authentic collection</p>
        </div>
        <div className="flex-1 overflow-y-auto p-6 pt-2">
          <div className="grid gap-4">
            {pizzaVarieties.map((item, index) => (
              <div
                key={index}
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="p-4 md:p-5 w-full md:w-3/5">
                ...
                <div className="mb-3">
                  ...
                  <Textarea
                    placeholder="Any special requests? (e.g., no olives, extra cheese)"
                    value={customNotes}
