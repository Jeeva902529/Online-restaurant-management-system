...
import jalebiImage from "../assets/jalebimenu.jpg" // Replace with actual image path
...
export default function JalebiMenu() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/jalebi") // Updated API endpoint
      ...
      <div className="relative h-[40vh] md:h-screen md:w-1/2 lg:w-3/5">
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-black/20 flex items-end p-8">
          <div>
            ...
            <p className="text-xl text-gray-200">Crispy, sweet spirals soaked in syrup</p>
          </div>
        </div>
      ...
      <div className="flex flex-1 flex-col bg-gray-50 md:h-screen md:overflow-hidden">
        <div className="sticky top-0 bg-gray-50 p-6 pb-4 z-10 shadow-sm">
          ...
          <h2 className="text-3xl font-bold">
            <span className="text-[#ff3131]">Flavors of Sweetness</span> <span className="text-[#122348]">Jalebi</span>
          </h2>
          <p className="text-gray-600 mt-1">Select your favorite Jalebi from our delightful collection</p>
        </div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <h3 className="mb-2 text-xl font-bold text-[#122348]">
                      {item.name} <span className="text-[#ff3131]">Jalebi</span>
                    </h3>
              ...
              <div className="p-4 md:p-5 w-full md:w-3/5">
                ...
                <div className="md:hidden mb-3">
                  <h2 className="text-xl font-bold text-[#122348]">
                    {selectedJalebi?.name} <span className="text-[#ff3131]"></span>
                  </h2>
                </div>
